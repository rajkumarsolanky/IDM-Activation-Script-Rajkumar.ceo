...
::  for the powershell method and solving special characters issue in file path name.
...
echo:        		
echo:                  ◇────────────────────◇
call :_color2 %_White% " " %_Red% "		      IDM Activation"
call :_color2 %_White% " " %_Green% "                      Rajkumar.CEO" 			
echo:                  ◇────────────────────◇
echo:           
echo:
call :_color2 %_White% "        " %_Green% "  Create By Rajkumar.CEO"           
